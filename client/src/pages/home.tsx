            ...
            <div className="bg-gradient-to-r from-eden-sage/10 to-eden-brown/10 rounded-lg p-3 md:p-4 border border-eden-brown/20 mx-2 md:mx-0">
              <div>
                <div className="flex items-center justify-between mb-2">
                  <h4 className="text-sm md:text-base font-bold text-eden-red font-korean">입금계좌</h4>
                  <div className="text-sm md:text-base font-bold text-eden-red">
                    농협 352-1701-3342-63 (예금주: 손*진)
                  </div>
                </div>
                <p className="text-xs text-gray-600 text-center">주문 후 위 계좌로 입금해 주시면 확인 후 발송해 드립니다</p>
              </div>
            </div>
          </div>
